$(function () {
    ...
    function check_title() {
        ...
        if (title.length >= 2 && pattern.test(title)) {
            ...
            title_error_msg.html("Le titre doit avoir plus de 2 caractères et moins de 50 caractères")
                .show();
    ...
    function check_email() {
        ...
        if (isValidEmailAddress(email)) {
            ...
            email_error_msg.html("L'adresse mail n'est pas valide")
                .show();
    ...
    function check_name() {
        ...
        if (pattern.test(name)) {
            ...
            name_error_msg.html("Le nom doit avoir plus de 2 caractères et moins de 50 caractères")
                .show();
    ...
    function check_desc() {
        ...
        if (pattern.test(desc)) {
            ...
            desc_error_msg.html("La description doit avoir plus de 20 caractères et moins de 2000 caractères")
                .show();
